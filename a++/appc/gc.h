...
/* compiled:								*/
  GC_API GC_PTR GC_malloc_atomic_uncollectable
...
/* mistaken for dynamic library data segments on some systems.		*/
  GC_API void GC_exclude_static_roots
    GC_PROTO ((GC_PTR start, GC_PTR finish));
...
/* objects allocated in this way for overwrites, etc.			*/
  ...
  GC_API GC_PTR GC_debug_realloc
    GC_PROTO ((GC_PTR old_object, size_t new_size_in_bytes, GC_EXTRA_PARAMS));
...
/* finalization order.						*/
  ...
  /* cleared.                                             */
  GC_API int GC_unregister_disappearing_link
    GC_PROTO ((GC_PTR * /* link */ ));
...
/* pointers introduced by the debugging allocators.			*/
  GC_API GC_PTR GC_make_closure
    GC_PROTO ((GC_finalization_proc fn, GC_PTR data));
